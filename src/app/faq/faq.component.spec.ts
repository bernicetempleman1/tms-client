...
describe('FaqComponent', () => {
  ...
  it('should display the FAQ description', () => {
    ...
    expect(descriptionElement.textContent).toContain('Here are some common questions and answers about the Task Management System:');
  });

  it('should display all FAQ cards', () => {
    const compiled = fixture.nativeElement;
    const cardElements = compiled.querySelectorAll('.faq__card');
    expect(cardElements.length).toBe(2); // Check if there are 5 FAQ cards
  });
});
